...
// Standardize user-agent header. Only use "zuqaapm-node" if it matches "zuqa-apm-node".
if (packageName === 'zuqa-apm-node') {
  packageName = 'zuqaapm-node'
}
...
function loadConfigFile (configFile) {
  const confPath = path.resolve(configFile || process.env.ZUQA_APM_CONFIG_FILE || 'zuqa-apm-node.js')
