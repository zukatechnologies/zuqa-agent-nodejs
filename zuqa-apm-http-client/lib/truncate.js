...
exports.transaction_metricset = truncTransactionMetricSet
...
function truncTransactionMetricSet (transaction_metricsets, opts) {
  return breadthFilter(transaction_metricsets, {
    onArray,
    onObject,
    onValue (value, key, path) {
      if (typeof value !== 'string') {
