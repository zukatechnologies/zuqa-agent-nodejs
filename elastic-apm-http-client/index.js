...
Client.encoding = Object.freeze({
  ...
  TRANSACTION_METRICSET: Symbol('transaction_metricset')
})
...
Client.prototype._encode = function (obj, enc) {
  ...
  switch (enc) {
    ...
    case Client.encoding.METRICSET:
      ...
      break
    case Client.encoding.TRANSACTION_METRICSET:
      out.transaction_metricset = truncate.transaction_metricset(obj.transaction_metricset, this._conf)
      break
  }
...
Client.prototype.sendTransactionMetricSet = function (transaction_metricset, cb) {
  this._maybeCork()
  return this.write({ transaction_metricset }, Client.encoding.TRANSACTION_METRICSET, cb)
}
