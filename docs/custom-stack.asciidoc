...
Here's a simple example of how Zuqa APM is normally required and started:
...
http.createServer(function (req, res) {
  ...
  // If no match is found, respond with a 404. Zuqa APM will in
...
// Add the Zuqa APM middleware after your regular middleware
