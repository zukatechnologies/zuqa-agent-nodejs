...
please https://github.com/zukatechnologies/apm-agent-nodejs/issues[open an issue] so we can make sure to support your stack.
In the meantime, you can <<custom-stack,configure Zuqa APM to work with any stack>>.

[float]
[[koa-installation]]
==== Installation

Add the `zuqa-apm-node` module as a dependency to your application:
