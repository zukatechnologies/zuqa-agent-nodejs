...
Support for the Zuqa APM Node.js agent follows the support schedule of Node.js itself to the end-of-life period of each version after its maintenance term.
...
Though you can use Zuqa APM <<custom-stack,with any Node.js framework>>,
...
When viewing a span in Zuqa APM,
...
please create a new topic in the https://discuss.elastic.co/c/apm[Zuqa APM discuss forum] and include information about your dependencies.
...
The Zuqa APM agent monitors async operations in your Node.js application to maintain awareness of which request is the active request at any given time.
...
please create a new topic in the https://discuss.elastic.co/c/apm[Zuqa APM discuss forum] and include information about your dependencies and what data is missing.
