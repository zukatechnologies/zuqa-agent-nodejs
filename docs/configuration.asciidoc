...
* *Env:* `ZUQA_APM_SERVICE_NAME`

Your Zuqa APM service name.
...
* *Type:* String
* *Env:* `ZUQA_APM_SERVICE_NODE_NAME`
...
* *Type:* String
* *Default:* `http://localhost:32140`
* *Env:* `ZUQA_APM_SERVER_URL`
...
* *Type:* Boolean
* *Default:* `true`
* *Env:* `ZUQA_APM_VERIFY_SERVER_CERT`
...
* *Type:* String
* *Env:* `ZUQA_APM_SERVER_CA_CERT_FILE`
...
* *Type:* Boolean
* *Default:* `true`
* *Env:* `ZUQA_APM_INSTRUMENT_INCOMING_HTTP_REQUESTS`
...
please https://github.com/zukatechnologies/apm-agent-nodejs/issues[open an issue].
...
* *Type:* Boolean
* *Default:* `false`
* *Env:* `ZUQA_APM_ERROR_ON_ABORTED_REQUESTS`
...
* *Type:* Number
* *Default:* `25s`
* *Env:* `ZUQA_APM_ABORTED_ERROR_THRESHOLD`
...
* *Type:* Number
* *Default:* `1.0`
* *Env:* `ZUQA_APM_TRANSACTION_SAMPLE_RATE`
...
* *Type:* String
* *Env:* `ZUQA_APM_FRAMEWORK_VERSION`
...
* *Type:* Boolean
* *Default:* `true`
* *Env:* `ZUQA_APM_CAPTURE_EXCEPTIONS`
...
* *Type:* Boolean
* *Default:* `false`
* *Env:* `ZUQA_APM_LOG_UNCAUGHT_EXCEPTIONS`
...
* *Type:* String
* *Default:* `messages`
* *Env:* `ZUQA_APM_CAPTURE_ERROR_LOG_STACK_TRACES`
...
* *Type:* Boolean
* *Default:* `true`
* *Env:* `ZUQA_APM_CAPTURE_SPAN_STACK_TRACES`
...
* *Type:* Boolean
* *Default:* `false`
* *Env:* `ZUQA_APM_USE_PATH_AS_TRANSACTION_NAME`
...
* *Type:* Number
* *Default:* `5`
* *Env:* `ZUQA_APM_SOURCE_LINES_ERROR_APP_FRAMES`
...
* *Type:* Number
* *Default:* `5`
* *Env:* `ZUQA_APM_SOURCE_LINES_ERROR_LIBRARY_FRAMES`
...
* *Type:* Number
* *Default:* `0`
* *Env:* `ZUQA_APM_SOURCE_LINES_SPAN_APP_FRAMES`
...
* *Type:* Number
* *Default:* `0`
* *Env:* `ZUQA_APM_SOURCE_LINES_SPAN_LIBRARY_FRAMES`
...
* *Type:* String
* *Default:* `2kb`
* *Env:* `ZUQA_APM_ERROR_MESSAGE_MAX_LENGTH`
...
* *Type:* Number
* *Default:* `50`
* *Env:* `ZUQA_APM_STACK_TRACE_LIMIT`
...
* *Type:* Number
* *Default:* `500`
* *Env:* `ZUQA_APM_TRANSACTION_MAX_SPANS`
...
* *Type:* Boolean
* *Default:* `true`
* *Env:* `ZUQA_APM_FILTER_HTTP_HEADERS`
...
* *Env:* `ZUQA_APM_DISABLE_INSTRUMENTATIONS`
...
[source,bash]
----
ZUQA_APM_DISABLE_INSTRUMENTATIONS=graphql,express-graphql
----

For an always up-to-date list of modules for which instrumentation can be disabled,
see the https://github.com/zukatechnologies/apm-agent-nodejs/tree/master/lib/instrumentation/modules[lib/instrumentation/modules] folder in the agent repository.
...
[source,bash]
----
ZUQA_APM_GLOBAL_LABELS="subspace=sap-hana,rack=number6"
----
...
* *Type:* String
* *Default:* `zuqa-agent-node.js`
* *Env:* `ZUQA_APM_CONFIG_FILE`

The Node.js agent will look for a file named `zuqa-agent-node.js` in the current working directory.
You can specify a custom path using this config option (this path must include the filename), e.g:

[source,bash]
----
ZUQA_APM_CONFIG_FILE=/path/to/my-zuqa-agent-node.js
----

NOTE: The inline version of this config option,
that is passed to the <<apm-start,`start`>> function,
will be ignored if a config file was already loaded when this module was required (based on either the default value or because of the `ZUQA_APM_CONFIG_FILE` environment variable).
...
* *Type:* Boolean
* *Default:* `true`
* *Env:* `ZUQA_APM_BREAKDOWN_METRICS`
